...
try {
	...
	out.println("Ticket booked successfully your ticket number is "+t+" please show this in counter and get your ticket");
				con.close();
	%>
	<br/><br/><center><a href="index.html"><b>HOME</b></a></center>
